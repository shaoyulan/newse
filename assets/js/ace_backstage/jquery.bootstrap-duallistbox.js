...
;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      infoText: '{0}個項目',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-inline label-warning">找到</span> {0} from {1}', // when not all of the options are visible due to the filter
  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '     <button type="button" class="btn btn-primary btn-sm clear1 pull-right"></button>' +
        '   </span>' +
        '   <input class="filter" type="text">' +
        '   <div class="btn-group buttons">' +
        '     <button type="button" class="btn btn-light-primary col-6 moveall">' +
        '       <i class="fa fa-angle-double-right" aria-hidden="true"></i>' +
        '     </button>' +
        '     <button type="button" class="btn btn-light-primary col-6 move">' +
        ...
        '   <span class="info-container">' +
        '     <span class="info"></span>' +
        '     <button type="button" class="btn btn-primary btn-sm clear2 pull-right"></button>' +
        '   </span>' +
        '   <input class="filter" type="text">' +
        '   <div class="btn-group buttons">' +
        '     <button type="button" class="btn btn-light-primary col-6 remove">' +
        '       <i class="fa fa-angle-left" aria-hidden="true"></i>' +
        '     </button>' +
        '     <button type="button" class="btn btn-light-primary col-6 removeall">' +
