...
* [#13583](http://dev.ce1.com/ticket/13583): Fixed: [`DataTransfer.getData()`](http://docs.ce1.com/#!/api/ce1.plugins.clipboard.dataTransfer-method-getData) should work consistently in all browsers and should not strip valuable content. Fixed pasting tables from Microsoft Excel on Chrome.
...
* Toolbar configurators:
  * [#13185](http://dev.ce1.com/ticket/13185): Fixed: Wrong position of the suggestion box if there is not enough space below the caret.
...
* [#8024](http://dev.ce1.com/ticket/8024): Swapped behavior of the Split Cell Vertically and Horizontally features of the [Table Tools](http://ce1.com/addon/tabletools) plugin to be more intuitive. Thanks to [kevinisagit](https://github.com/kevinisagit)!
...
* [#12796](http://dev.ce1.com/ticket/12796): Fixed: The [Indent List](http://ce1.com/addon/indentlist) plugin unwraps parent `<li>` elements. Thanks to [Andrew Stucki](https://github.com/andrewstucki)!
...
* [#12387](http://dev.ce1.com/ticket/12387): Fixed: An error is thrown if a skin does not have the [`chameleon`](http://docs.ce1.com/#!/api/ce1.skin-method-chameleon) property defined and [`config.uiColor`](http://docs.ce1.com/#!/api/ce1.config-cfg-uiColor) is defined.
...
* [#11757](http://dev.ce1.com/ticket/11757): Fixed: Imperfections in the [Moono](http://ce1.com/addon/moono) skin. Thanks to [danyaPostfactum](https://github.com/danyaPostfactum)!
...
* [#9661](http://dev.ce1.com/ticket/9661): Added the option to [configure](http://docs.ce1.com/#!/api/ce1.config-cfg-linkJavaScriptLinksAllowed) anchor tags with JavaScript code in the `href` attribute.
...
* [#11297](http://dev.ce1.com/ticket/11297): Styles can now be applied to widgets. The definition of a style which can be applied to a specific widget must contain two additional properties &mdash; `type` and `widget`. Read more in the [Widget Styles](http://docs.ce1.com/#!/guide/dev_styles-section-widget-styles) section of the "Syles Drop-down" guide. Note that by default, widgets support only classes and no other attributes or styles. Related changes and features:
  ...
  * Integration with the [Allowed Content Filter](http://docs.ce1.com/#!/guide/dev_advanced_content_filter) required an introduction of the [`ce1.style.toAllowedContent()`](http://docs.ce1.com/#!/api/ce1.style-method-toAllowedContentRules) method which can be implemented by the custom style handler and if exists, it is used by the [`ce1.filter`](http://docs.ce1.com/#!/api/ce1.filter) to translate a style to [allowed content rules](http://docs.ce1.com/#!/api/ce1.filter.allowedContentRules).
...
* [#11438](http://dev.ce1.com/ticket/11438): Splitting table cells vertically is no longer changing table structure.
...
* [#11133](http://dev.ce1.com/ticket/11133): [Page Break](http://ce1.com/addon/pagebreak) becomes editable if pasted.
...
* [#11165](http://dev.ce1.com/ticket/11165): Fixed: The [File Browser](http://ce1.com/addon/filebrowser) plugin cannot be removed from the editor.
...
* [#10612](http://dev.ce1.com/ticket/10612): Internet Explorer 11 support.
...
* [#11079](http://dev.ce1.com/ticket/11079): Add button icons to the [Placeholder](http://ce1.com/addon/placeholder) sample.
...
* [#9764](http://dev.ce1.com/ticket/9764): Widget System.
  ...
  * "Fake" selection was introduced. It makes it possible to virtually select any element when the real selection remains hidden. See the  [`selection.fake()`](http://docs.ce1.com/#!/api/ce1.dom.selection-method-fake) method.
...
* [#10812](http://dev.ce1.com/ticket/10812): Fixed [`range.createBookmark2()`](http://docs.ce1.com/#!/api/ce1.dom.range-method-createBookmark2) incorrectly normalizing offsets. This bug was causing many issues: [#10850](http://dev.ce1.com/ticket/10850), [#10842](http://dev.ce1.com/ticket/10842).
...
* [#10146](http://dev.ce1.com/ticket/10146): [Firefox] Empty lines are being removed while [`config.enterMode`](http://docs.ce1.com/#!/api/ce1.config-cfg-enterMode) is [`ce1.ENTER_BR`](http://docs.ce1.com/#!/api/ce1-property-ENTER_BR).
* [#10360](http://dev.ce1.com/ticket/10360): Fixed: ARIA `role="application"` should not be used for dialog windows.
* [#10361](http://dev.ce1.com/ticket/10361): Fixed: ARIA `role="application"` should not be used for floating panels.
* [#10510](http://dev.ce1.com/ticket/10510): Introduced unique voice labels to differentiate between different editor instances.
* [#9945](http://dev.ce1.com/ticket/9945): [iOS] Scrolling not possible on iPad.
* [#10389](http://dev.ce1.com/ticket/10389): Fixed: Invalid HTML in the "Text and Table" template.
* [WebSpellChecker](http://ce1.com/addon/wsc) plugin user interface was changed to match CKEditor 4 style.
...
* [#10172](http://dev.ce1.com/ticket/10172): Pressing *Delete* or *Backspace* in an empty table cell moves the cursor to the next/previous cell.
* [#10219](http://dev.ce1.com/ticket/10219): Error thrown when destroying an editor instance in parallel with a `mouseup` event.
* [#10265](http://dev.ce1.com/ticket/10265): Wrong loop type in the [File Browser](http://ce1.com/addon/filebrowser) plugin.
* [#10249](http://dev.ce1.com/ticket/10249): Wrong undo/redo states at start.
* [#10268](http://dev.ce1.com/ticket/10268): [Show Blocks](http://ce1.com/addon/showblocks) does not recover after switching to Source view.
* [#9995](http://dev.ce1.com/ticket/9995): HTML code in the `<textarea>` should not be modified by the [`htmlDataProcessor`](http://docs.ce1.com/#!/api/ce1.htmlDataProcessor).
* [#10320](http://dev.ce1.com/ticket/10320): [Justify](http://ce1.com/addon/justify) plugin should add elements to Advanced Content Filter based on current [Enter mode](http://docs.ce1.com/#!/api/ce1.config-cfg-enterMode).
* [#10260](http://dev.ce1.com/ticket/10260): Fixed: Advanced Content Filter blocks [`tabSpaces`](http://docs.ce1.com/#!/api/ce1.config-cfg-tabSpaces). Unified `data-cke-*` attributes filtering.
* [#10315](http://dev.ce1.com/ticket/10315): [WebKit] [Undo manager](http://docs.ce1.com/#!/api/ce1.plugins.undo.UndoManager) should not record snapshots after a filling character was added/removed.
* [#10291](http://dev.ce1.com/ticket/10291): [WebKit] Space after a filling character should be secured.
* [#10330](http://dev.ce1.com/ticket/10330): [WebKit] The filling character is not removed on `keydown` in specific cases.
* [#10285](http://dev.ce1.com/ticket/10285): Fixed: Styled text pasted from MS Word causes an infinite loop.
* [#10131](http://dev.ce1.com/ticket/10131): Fixed: [`undoManager.update()`](http://docs.ce1.com/#!/api/ce1.plugins.undo.UndoManager-method-update) does not refresh the command state.
* [#10337](http://dev.ce1.com/ticket/10337): Fixed: Unable to remove `<s>` using [Remove Format](http://ce1.com/addon/removeformat).

## CKEditor 4.1

Fixed Issues:

* [#10192](http://dev.ce1.com/ticket/10192): Closing lists with the *Enter* key does not work with [Advanced Content Filter](http://docs.ce1.com/#!/guide/dev_advanced_content_filter) in several cases.
* [#10191](http://dev.ce1.com/ticket/10191): Fixed allowed content rules unification, so the [`filter.allowedContent`](http://docs.ce1.com/#!/api/ce1.filter-property-allowedContent) property always contains rules in the same format.
* [#10224](http://dev.ce1.com/ticket/10224): Advanced Content Filter does not remove non-empty `<a>` elements anymore.
* Minor issues in plugin integration with Advanced Content Filter:
  * [#10166](http://dev.ce1.com/ticket/10166): Added transformation from the `align` attribute to `float` style to preserve backward compatibility after the introduction of Advanced Content Filter.
  * [#10195](http://dev.ce1.com/ticket/10195): [Image](http://ce1.com/addon/image) plugin no longer registers rules for links to Advanced Content Filter.
  * [#10213](http://dev.ce1.com/ticket/10213): [Justify](http://ce1.com/addon/justify) plugin is now correctly registering rules to Advanced Content Filter when [`config.justifyClasses`](http://docs.ce1.com/#!/api/ce1.config-cfg-justifyClasses) is defined.

## CKEditor 4.1 RC

New Features:

* [#9829](http://dev.ce1.com/ticket/9829): Advanced Content Filter - data and features activation based on editor configuration.

  Brand new data filtering system that works in 2 modes:

  * Based on loaded features (toolbar items, plugins) - the data will be filtered according to what the editor in its
  current configuration can handle.
  * Based on [`config.allowedContent`](http://docs.ce1.com/#!/api/ce1.config-cfg-allowedContent) rules - the data
  will be filtered and the editor features (toolbar items, commands, keystrokes) will be enabled if they are allowed.

  See the `datafiltering.html` sample, [guides](http://docs.ce1.com/#!/guide/dev_advanced_content_filter) and [`ce1.filter` API documentation](http://docs.ce1.com/#!/api/ce1.filter).
* [#9387](http://dev.ce1.com/ticket/9387): Reintroduced [Shared Spaces](http://ce1.com/addon/sharedspace) - the ability to display toolbar and bottom editor space in selected locations and to share them by different editor instances.
* [#9907](http://dev.ce1.com/ticket/9907): Added the [`contentPreview`](http://docs.ce1.com/#!/api/ce1-event-contentPreview) event for preview data manipulation.
* [#9713](http://dev.ce1.com/ticket/9713): Introduced the [Source Dialog](http://ce1.com/addon/sourcedialog) plugin that brings raw HTML editing for inline editor instances.
* Included in [#9829](http://dev.ce1.com/ticket/9829): Introduced new events, [`toHtml`](http://docs.ce1.com/#!/api/ce1.editor-event-toHtml) and [`toDataFormat`](http://docs.ce1.com/#!/api/ce1.editor-event-toDataFormat), allowing for better integration with data processing.
* [#9981](http://dev.ce1.com/ticket/9981): Added ability to filter [`htmlParser.fragment`](http://docs.ce1.com/#!/api/ce1.htmlParser.fragment), [`htmlParser.element`](http://docs.ce1.com/#!/api/ce1.htmlParser.element) etc. by many [`htmlParser.filter`](http://docs.ce1.com/#!/api/ce1.htmlParser.filter)s before writing structure to an HTML string.
* Included in [#10103](http://dev.ce1.com/ticket/10103):
  * Introduced the [`editor.status`](http://docs.ce1.com/#!/api/ce1.editor-property-status) property to make it easier to check the current status of the editor.
  * Default [`command`](http://docs.ce1.com/#!/api/ce1.command) state is now [`ce1.TRISTATE_DISABLE`](http://docs.ce1.com/#!/api/ce1-property-TRISTATE_DISABLED). It will be activated on [`editor.instanceReady`](http://docs.ce1.com/#!/api/ce1-event-instanceReady) or immediately after being added if the editor is already initialized.
* [#9796](http://dev.ce1.com/ticket/9796): Introduced `<s>` as a default tag for strikethrough, which replaces obsolete `<strike>` in HTML5.

## CKEditor 4.0.3

Fixed Issues:

* [#10196](http://dev.ce1.com/ticket/10196): Fixed context menus not opening with keyboard shortcuts when [Autogrow](http://ce1.com/addon/autogrow) is enabled.
* [#10212](http://dev.ce1.com/ticket/10212): [IE7-10] Undo command throws errors after multiple switches between Source and WYSIWYG view.
* [#10219](http://dev.ce1.com/ticket/10219): [Inline editor] Error thrown after calling [`editor.destroy()`](http://docs.ce1.com/#!/api/ce1.editor-method-destroy).

## CKEditor 4.0.2

Fixed Issues:

* [#9779](http://dev.ce1.com/ticket/9779): Fixed overriding [`ce1.getUrl()`](http://docs.ce1.com/#!/api/ce1-method-getUrl) with `ce1_GETURL`.
* [#9772](http://dev.ce1.com/ticket/9772): Custom buttons in the dialog window footer have different look and size ([Moono](http://ce1.com/addon/moono), [Kama](http://ce1.com/addon/kama) skins).
* [#9029](http://dev.ce1.com/ticket/9029): Custom styles added with the [`stylesSet.add()`](http://docs.ce1.com/#!/api/ce1.stylesSet-method-add) are displayed in the wrong order.
* [#9887](http://dev.ce1.com/ticket/9887): Disable [Magic Line](http://ce1.com/addon/magicline) when [`editor.readOnly`](http://docs.ce1.com/#!/api/ce1.editor-property-readOnly) is set.
* [#9882](http://dev.ce1.com/ticket/9882): Fixed empty document title on [`editor.getData()`](http://docs.ce1.com/#!/api/ce1.editor-method-getData) if set via the Document Properties dialog window.
* [#9773](http://dev.ce1.com/ticket/9773): Fixed rendering problems with selection fields in the Kama skin.
* [#9851](http://dev.ce1.com/ticket/9851): The [`selectionChange`](http://docs.ce1.com/#!/api/ce1.editor-event-selectionChange) event is not fired when mouse selection ended outside editable.
* [#9903](http://dev.ce1.com/ticket/9903): [Inline editor] Bad positioning of floating space with page horizontal scroll.
* [#9872](http://dev.ce1.com/ticket/9872): [`editor.checkDirty()`](http://docs.ce1.com/#!/api/ce1.editor-method-checkDirty) returns `true` when called onload. Removed the obsolete `editor.mayBeDirty` flag.
* [#9893](http://dev.ce1.com/ticket/9893): [IE] Fixed broken toolbar when editing mixed direction content in Quirks mode.
* [#9845](http://dev.ce1.com/ticket/9845): Fixed TAB navigation in the [Link](http://ce1.com/addon/link) dialog window when the Anchor option is used and no anchors are available.
* [#9883](http://dev.ce1.com/ticket/9883): Maximizing was making the entire page editable with [divarea](http://ce1.com/addon/divarea)-based editors.
* [#9940](http://dev.ce1.com/ticket/9940): [Firefox] Navigating back to a page with the editor was making the entire page editable.
* [#9966](http://dev.ce1.com/ticket/9966): Fixed: Unable to type square brackets with French keyboard layout. Changed [Magic Line](http://ce1.com/addon/magicline) keystrokes.
* [#9507](http://dev.ce1.com/ticket/9507): [Firefox] Selection is moved before editable position when the editor is focused for the first time.
* [#9947](http://dev.ce1.com/ticket/9947): [WebKit] Editor overflows parent container in some edge cases.
* [#10105](http://dev.ce1.com/ticket/10105): Fixed: Broken [sourcearea](http://ce1.com/addon/sourcearea) view when an RTL language is set.
* [#10123](http://dev.ce1.com/ticket/10123): [WebKit] Fixed: Several dialog windows have broken layout since the latest WebKit release.
* [#10152](http://dev.ce1.com/ticket/10152): Fixed: Invalid ARIA property used on menu items.
...
* [#9655](http://dev.ce1.com/ticket/9655): Support for IE Quirks Mode in the new [Moono skin](http://ce1.com/addon/moono).
* Accessibility issues (mainly in inline editor): [#9364](http://dev.ce1.com/ticket/9364), [#9368](http://dev.ce1.com/ticket/9368), [#9369](http://dev.ce1.com/ticket/9369), [#9370](http://dev.ce1.com/ticket/9370), [#9541](http://dev.ce1.com/ticket/9541), [#9543](http://dev.ce1.com/ticket/9543), [#9841](http://dev.ce1.com/ticket/9841), [#9844](http://dev.ce1.com/ticket/9844).
* [Magic Line](http://ce1.com/addon/magicline) plugin:
    * [#9481](http://dev.ce1.com/ticket/9481): Added accessibility support for Magic Line.
    * [#9509](http://dev.ce1.com/ticket/9509): Added Magic Line support for forms.
    * [#9573](http://dev.ce1.com/ticket/9573): Magic Line does not disappear on `mouseout` in a specific case.
* [#9754](http://dev.ce1.com/ticket/9754): [WebKit] Cutting & pasting simple unformatted text generates an inline wrapper in WebKit browsers.
* [#9456](http://dev.ce1.com/ticket/9456): [Chrome] Properly paste bullet list style from MS Word.
* [#9699](http://dev.ce1.com/ticket/9699), [#9758](http://dev.ce1.com/ticket/9758): Improved selection locking when selecting by dragging.
* Context menu:
    * [#9712](http://dev.ce1.com/ticket/9712): Opening the context menu destroys editor focus.
    * [#9366](http://dev.ce1.com/ticket/9366): Context menu should be displayed over the floating toolbar.
    * [#9706](http://dev.ce1.com/ticket/9706): Context menu generates a JavaScript error in inline mode when the editor is attached to a header element.
* [#9800](http://dev.ce1.com/ticket/9800): Hide float panel when resizing the window.
* [#9721](http://dev.ce1.com/ticket/9721): Padding in content of div-based editor puts the editing area under the bottom UI space.
* [#9528](http://dev.ce1.com/ticket/9528): Host page `box-sizing` style should not influence the editor UI elements.
* [#9503](http://dev.ce1.com/ticket/9503): [Form Elements](http://ce1.com/addon/forms) plugin adds context menu listeners only on supported input types. Added support for `tel`, `email`, `search` and `url` input types.
* [#9769](http://dev.ce1.com/ticket/9769): Improved floating toolbar positioning in a narrow window.
* [#9875](http://dev.ce1.com/ticket/9875): Table dialog window does not populate width correctly.
* [#8675](http://dev.ce1.com/ticket/8675): Deleting cells in a nested table removes the outer table cell.
* [#9815](http://dev.ce1.com/ticket/9815): Cannot edit dialog window fields in an editor initialized in the jQuery UI modal dialog.
* [#8888](http://dev.ce1.com/ticket/8888): CKEditor dialog windows do not show completely in a small window.
* [#9360](http://dev.ce1.com/ticket/9360): [Inline editor] Blocks shown for a `<div>` element stay permanently even after the user exits editing the `<div>`.
* [#9531](http://dev.ce1.com/ticket/9531): [Firefox & Inline editor] Toolbar is lost when closing the Format drop-down list by clicking its button.
* [#9553](http://dev.ce1.com/ticket/9553): Table width incorrectly set when the `border-width` style is specified.
* [#9594](http://dev.ce1.com/ticket/9594): Cannot tab past CKEditor when it is in read-only mode.
* [#9658](http://dev.ce1.com/ticket/9658): [IE9] Justify not working on selected images.
* [#9686](http://dev.ce1.com/ticket/9686): Added missing contents styles for `<pre>` elements.
* [#9709](http://dev.ce1.com/ticket/9709): [Paste from Word](http://ce1.com/addon/pastefromword) should not depend on configuration from other styles.
* [#9726](http://dev.ce1.com/ticket/9726): Removed [Color Dialog](http://ce1.com/addon/colordialog) plugin dependency from [Table Tools](http://ce1.com/addon/tabletools).
* [#9765](http://dev.ce1.com/ticket/9765): Toolbar Collapse command documented incorrectly in the [Accessibility Instructions](http://ce1.com/addon/a11yhelp) dialog window.
* [#9771](http://dev.ce1.com/ticket/9771): [WebKit & Opera] Fixed scrolling issues when pasting.
* [#9787](http://dev.ce1.com/ticket/9787): [IE9] `onChange` is not fired for checkboxes in dialogs.
* [#9842](http://dev.ce1.com/ticket/9842): [Firefox 17] When opening a toolbar menu for the first time and pressing the *Down Arrow* key, focus goes to the next toolbar button instead of the menu options.
* [#9847](http://dev.ce1.com/ticket/9847): [Elements Path](http://ce1.com/addon/elementspath) should not be initialized in the inline editor.
* [#9853](http://dev.ce1.com/ticket/9853): [`editor.addRemoveFormatFilter()`](http://docs.ce1.com/#!/api/ce1.editor-method-addRemoveFormatFilter) is exposed before it really works.
* [#8893](http://dev.ce1.com/ticket/8893): Value of the [`pasteFromWordCleanupFile`](http://docs.ce1.com/#!/api/ce1.config-cfg-pasteFromWordCleanupFile) configuration option is now taken from the instance configuration.
* [#9693](http://dev.ce1.com/ticket/9693): Removed "Live Preview" checkbox from UI color picker.
...
[1]: http://docs.ce1.com/#!/guide/dev_api_changes "API Changes"
