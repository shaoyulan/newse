   ...
   Plugin.prototype =
           {
              ...
              initTemplate: function ()
              {
                 ...
                 this.template = '<div class="dtp hidden" id="' + this.name + '">' +
                         ...
                         '<div class="dtp-close"><a href="javascript:void(0);"><i class="material-icons">關閉</i></a></div>' +
                         '</header>' +
              ...
              _onSelectHour: function (e)
              {
                 if (!$(e.target).hasClass('disabled'))
                 {
                    ...
                    var ok_btn = $(e.currentTarget).closest('.dtp-content').find('.dtp-btn-ok');
                    if(ok_btn.length > 0) ok_btn.click();
                 }
              },
